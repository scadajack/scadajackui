	...
	<script type='text/javascript'>
				$(document).ready(function(){
					jQuery('#serverTargets').jqGrid({
						url: "${createLink(controller:'pollingConfiguration', action:'pollConfigTargetList', id:pollingConfigurationInstance.id)}",
						editurl: "${createLink(controller:'pollingConfiguration', action:'pollConfigEditTargets', id:pollingConfigurationInstance.id)}",
						datatype : 'json',
						caption  : 'Target Tags',
						...
						colModel : [{name:'targetId',
									...
									{name:'enabled',width:20,editable:true,edittype:'checkbox',editoptions:{value:"true:false"}},
